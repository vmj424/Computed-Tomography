...
rng(1);
aaa= 0;
bbb= 0.05; %choose accordingly 0.02, 0.05 0.1
...
figure(235)
subplot(1,6,1), imshow(reshape(W1,N,N)), xlabel('Fine weight 25%'), title(['Accuracy Error = ' , num2str(A1)])
subplot(1,6,2), imshow(reshape(W2,N,N)), xlabel('Fine weight 50%'), title(['Accuracy Error = ' , num2str(A2)])
subplot(1,6,3), imshow(reshape(W3,N,N)), xlabel('Fine weight 75%'), title(['Accuracy Error = ' , num2str(A3)])
subplot(1,6,4), imshow(reshape(W4,N,N)), xlabel('Fine weight 95%'), title(['Accuracy Error = ' , num2str(A4)])
subplot(1,6,5), imshow(reshape(W5,N,N)), xlabel('Fine weight 99%'), title(['Accuracy Error = ' , num2str(A5)])
