%selct appropriate phantom from phantom gallery and change in line 100
clear
clc
close all
...
% fuzzy Fusion 
fis = readfis('tectonic_fusion'); % tectonic_fusion_ideal.fis for ideal case, tectonic_fusion.fis for Noisy case 
                                        % when DoD is 0.84,
                                        % tectonic_fusion_TV_noise.fis for
                                        % Noisy case when DOD os 0.42
...
fis2 = readfis('tectonic.fis'); % tectonic_ideal.fis for ideal case, tectonic_.fis for noisy case when DoD is 0.84
                              % and tectonic_TV_noise.fis for noise case
                              % when DOD is 0.42.
                              % 
input =  [x1(:)];
