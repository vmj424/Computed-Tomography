...
rng(1);
aaa= 0;
bbb= 0.1; %choose accordingly 0.02, 0.05 0.1
...
subplot(1,2,1),imagesc(reshape(xf,N,N)),xlabel('Actual');
colormap gray

figure(12)
subplot(1,2,2),histogram(U(:),100), xlabel('FBP');
title(['RRMSE (%) = ', num2str(RRMSE)])%, xlabel('10643 elements in A with 29 projections')
subplot(1,2,1),histogram(xf,100),xlabel('Actual');
colormap gray
...
subplot(1,2,2),imshow(reshape(fuzzy2,N,N)), xlabel('Refinement'),set(gca,'FontSize',14)
colormap gray

figure(32)
subplot(1,2,1), histogram(xf,100), title('Actual'), xlabel('Grayscale value'), ylabel('Number of pixels'),set(gca,'FontSize',14)
subplot(1,2,2), histogram(fuzzy2,100),title('Refinement'), xlabel('Grayscale value'), ylabel('Number of pixels'),set(gca,'FontSize',14)
%%
                                            % Accuracy Error 
...
% subplot(2,5,2), imshow((reshape(U(:),[N,N]))), xlabel('FBP'),set(gca,'FontSize',14)
...
%title(['DoD =' , num2str(DoD2)])
subplot(2,5,2), imshow((reshape(U(:),[N,N]))), xlabel('Filtered Back Projection'),set(gca,'FontSize',16)
% title(['Accuracy Error = ' , num2str(A1)])
...
Method = [{'FBP'}, {'Coarse'}, {'Mean'}, {'Weighted_average'}, {'Product'}, {'Min'}, {'Max'},{'Fuzzy'}, {'Refinement'}]';
...
% figure(101)
% subplot(1,2,1),imshow(reshape(xf,N,N)), xlabel('Original'),set(gca,'FontSize',14)
% subplot(1,2,2),imshow(reshape(fuzzy2,N,N)), xlabel('Coarse'),set(gca,'FontSize',14)
% colormap gray
% 
% figure(02)
% subplot(1,2,1), histogram(xf,100), title('Original'), xlabel('Grayscale value'), ylabel('Number of pixels'),set(gca,'FontSize',14)
% subplot(1,2,2), histogram(fuzzy2,100),title('Coarse'), xlabel('Grayscale value'), ylabel('Number of pixels'),set(gca,'FontSize',14)