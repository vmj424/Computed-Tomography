...
% fuzzy Fusion 
fis = readfis('smooth_fusion_ideal'); % smooth_fusion_ideal.fis for ideal
                                    % case both 0.84 and 0.42
...
fis2 = readfis('smooth_ideal'); % smooth_ideal.fis for ideal case in DoD 0.84
                              % and 0.42
