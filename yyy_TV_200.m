...
% Use A_Coll_256.mat when 256X256 shepp-logan and ideal case
%load('A_Coll_200.mat') % obtained when nA = 150, d_f = 362, p= 370, k =2, d_c =181, theata = 1.2
...
% p1 = n;
% q1 = n;
% [U1,out] = TVAL3(A_collapsed,yt1,p1,q1,opts);
% figure(11)
% subplot(1,2,2),imagesc(reshape(U,N,N)), xlabel('TV-regularization');
% title(['RRMSE (%) = ', num2str(RRMSE)])
% subplot(1,2,1),imagesc(reshape(U1,n,n)),xlabel('Origional');
% colormap gray
% 
% Xc_t1 = U1;
